...
- 更新前端 UI 或新增功能前，先核对项目锁定的 GPUI Kit 版本，并查阅[官方组件文档](https://gpui-kit.com/zh-CN/component/)中对应组件的用法与示例；官方组件/API 能满足当前已确认的交互、视觉和状态约束时，优先采用官方用法，只有无法满足时再考虑自定义控件，并说明原因。
