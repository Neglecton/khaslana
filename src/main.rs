...
use khaslana::{
    ...
    SubmoduleInfo, SubmoduleRemoteSyncStatus, TagName, credential_display_target,
...
impl RepositoryView {
    ...
    pub(crate) fn focused_field(&self, window: &Window, _cx: &App) -> Option<FieldId> {
        [
...
pub(crate) fn dedupe_repo_paths(paths: Vec<PathBuf>) -> Vec<PathBuf> {
